...
module.exports = function (app) {
    ...
    return function (options) {
        ...
        app.use('/api/api-docs.json', function (req, res) {
            res.json(swaggerObject);
        });

        app.use('/api/api-docs', swaggerUi({
            docs: options.swaggerDefinition.jsonurl || '/api-docs.json' // from the express route above.
        }));
